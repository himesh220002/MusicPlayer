...
const lyricsData = {
  'Eminem-Beautiful-Pain': `  I can feel the heat risin'
  ...
  You wake in its wake to start the 
  mourning process
  And rebuilding, you're still a work 
  in progress
  ...
  with the thornbush that ya
  Used to smell the roses
  Stopped to inhale, can't even tell your 
  nose is Stuffed, so focused on the bright 
  side then you floor the gas pedal
  And hit the corner faster, more assertive
  Never looking back, may hit the curb
  But every day is a new learning curve as 
  you steer through life Sometimes you might 
  not wanna swerve but you have to
  To avert a disaster, lucky no permanent 
  damage
  ...
  converted to gasoline And while 
  you're burning the past
  ...
  It happens all the time, they take your 
  heart and steal your life
  ...
  And I'm pullin' for you to push through this 
  feeling
  And with a little time that should do the healing
  And by tomorrow, you may even feel so good that 
  you're willing

  To forgive 'em, even after all the shit you been 
  put through
  This feeling of resilience is building
  And the flames are burnin' quick as fire would 
  through this building
  You're sealed in, but you're fireproof
  Flame retardant, you withstood it
  And as you climb up to the roof, you're just 
  chillin'
  You look down, 'cause you're so over 'em you could put 
  ...
  'Taylor_Swift_-_Blank_Space': `Nice to meet you, where you been?
  ...
  'Taylor-Swift-22' :`It feels like a perfect night
  ...
  'Taylor-Swift-White-Horse' : `Say you're sorry, that face of an angel
  ...
  (You, now, I see, even when I close my eyes)`
  ,
  "Linkin Park - One Step Closer":` I cannot take this anymore
